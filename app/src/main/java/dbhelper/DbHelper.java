...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public DbHelper(Context context) {
        ...
        DATABASE_PATH = "/data/data/" + context.getPackageName() + "/databases/lucassalesorder.db/";
    }
    public SQLiteDatabase readDataBase() {
        try {
            InputStream in = this.context.getAssets().open(FILENAME);
            Log.e("sample", "Starting copying");
            File databaseFile = new File("/data/data/" + this.context.getPackageName() + "/databases/lucassalesorder.db/");
